    ...
    <div class="navbar jb-all" :class="{hidden: !navShow}">
      <div class="width-limit">
        ...
        <div class="nav-right">
          ...
          <div v-if="login.status" class="user-img">
            <img
              @click="menuStatus"
            ...
            <div v-show="menuShow" class="menu-list">
              <div class="item-group">
                <div class="item border-line-bottom">
                  <a :href="writeUrl" class="menu-write-btn">
                    <i class="iconfont icon-icon5"></i>
                    {{ writeText }}
                  </a>
                </div>
              ...
              <!--<div class="item-group">-->
                <!--<div class="item border-line-bottom">-->
                  <!--<a class="menu-write-btn" @click="loginOut">-->
...
<script lang="ts">
    ...
    export default Vue.extend({
        ...
        methods: {
            ...
            loginOut() {
                console.log(this)
                Cookies.remove('logged.sig')
                Cookies.remove('logged')
                Cookies.remove('SYSESSIONID')
                Cookies.remove('SYSESSIONID.sig')
                Cookies.remove('WEBASCIIID.sig')
                Cookies.remove('WEBASCIIID')
